var Ad = {
  ...
  */
  animate: function () {
    ...
    switch (myFT.instantAds.elementsOrder) {
      case 'copy|lockup':
       console.log('copy|lockup');
       animateHeadlines();
       if(myFT.instantAds.F1_lockup_img.indexOf("blank") > -1) {
        //
      } else {
        gsap.to('#lockup1', { duration: 0, opacity: 0 }, 0);
      }
       Ad.timeline.from('#lockup2', { delay: 4, duration: 1.25, x: -Ad.width }, 0);
       Ad.timeline.from('div#headline > span', {delay: 4, duration: 1.25, x: 0 }, 0);
       Ad.timeline.from('div#subheadline > span', { delay: 4, duration: 1.25, x: 0 }, 0);

       if (Ad.hasPercent) {
        Ad.timeline.from('div#percent', { delay: 4,duration: 1, x: -Ad.width }, 0);
      }
      if (Ad.hasPrice)  {
        Ad.timeline.from('div#price', { delay: 4,duration: 1, x: -Ad.width }, 0);
      }


       Ad.timeline.from('div#headline > span', {delay: 8, duration: 1.25, x: -Ad.width }, 0);
       Ad.timeline.from('div#subheadline > span', { delay: 8, duration: 1.25, x: -Ad.width }, 0);
       
       if (Ad.hasPercent) {
        Ad.timeline.to('div#percent', { delay: 8,duration: 1, x: 0 }, 0);
      }
      if (Ad.hasPrice)  {
        Ad.timeline.to('div#price', { delay: 8,duration: 1, x: 0 }, 0);
      }
       
       break;
      case 'lockup|lockup':
        gsap.to('div#headline > span', { duration: 0, alpha: 0 }, 0);
        gsap.to('div#subheadline > span', { duration: 0, alpha: 0 }, 0);

        if (Ad.hasPercent) {
          gsap.to('div#percent', { duration: 0, alpha: 0 }, 0);
         
        }
        if (Ad.hasPrice)  {
          gsap.to('div#price', { duration: 0, alpha: 0 }, 0);
        }



        console.log('lockup|lockup');
        Ad.timeline.from('#lockup1', { duration: 1.25, x: -Ad.width }, 0);
        Ad.timeline.from('#lockup2', { delay: 4, duration: 1.25, x: -Ad.width }, 0);
      ...
      case 'lockup|copy':
        console.log('lockup|copy');
        if(myFT.instantAds.F2_lockup_img.indexOf("blank") > -1) {
          //
        } else {
          gsap.to('#lockup2', { duration: 0, opacity: 0 }, 0);
        }
         
        
        Ad.timeline.from('#lockup1', {  duration: 1.25, x: -Ad.width }, 0);

        Ad.timeline.from('div#headline > span', {delay: 4, duration: 1.25, x: -Ad.width }, 0);
        Ad.timeline.from('div#subheadline > span', { delay: 4, duration: 1.25, x: -Ad.width }, 0);
        ...
        if (Ad.hasPercent) {
          Ad.timeline.from('div#percent', { delay: 8,duration: 1, x: -Ad.width }, 0);
        }
        if (Ad.hasPrice)  {
          Ad.timeline.from('div#price', { delay: 8,duration: 1, x: -Ad.width }, 0);
        }
      ...
      function hideLockups() {
       ...
       // Ad.timeline.from('#lockup1', { duration: 1.25, x: -Ad.width, stagger: 0.25 }, 0);
  

      //  Ad.timeline.from('#lockup2', { duration: 1.25, x: -Ad.width, stagger: 0.25 }, 0);
  ...
  build: function () {
    ...
    if ( myFT.instantAds.percentage_txt !== "" 
      ...
      if(myFT.instantAds.percentage_txt.includes('|')) {
        ...
        percentAside.style.fontSize = 7 + 'px';
        percentAside.style.lineHeight = 9.3 + 'px';
        ...
        percent.style.height = (myFT.instantAds.percentage_size_hex_xy.split('|')[0] * .89 - 1) + 'px';
    ...
    if ( myFT.instantAds.price_txt !== ""
      ...
      if(myFT.instantAds.price_txt.includes('|')) {
       ...
       '<span style = "display: flex; line-height: 1.3em; font-size: ' + myFT.instantAds.price_size_hex_xy.split('|')[0]/2 + 'px">' + 
      ...
      frame1Image.addEventListener("load", function() {
        ...
        if(myFT.instantAds.F1_lockup_img.indexOf("blank") > -1 && myFT.instantAds.F2_lockup_img.indexOf("blank") > -1) {
        ...
        function setupLockup1() {
          console.log('build lockup 1');
          frame1LockupImage = document.createElement('img');
          frame1LockupImage.src = myFT.instantAds.F1_lockup_img;
          frame1LockupImage.addEventListener("load", function() {
            //frame1LockupImage.style.width = '100%';
            //frame1LockupImage.style.height = '100px';
            frame1LockupImage.style.position = 'absolute';
            frame1LockupImage.style.top = 0;
            frame1LockupImage.id = 'lockup1';
            frame1LockupImage.style.pointerEvents = 'none';
            //frame1LockupImage.style.backgroundSize = 'contain';
          
            frame1LockupImage.style.marginTop = myFT.instantAds.F1_lockupImg_xy.split(',')[1] + 'px';
            frame1LockupImage.style.marginLeft = myFT.instantAds.F1_lockupImg_xy.split(',')[0] + 'px';
            //gsap.to(frame1LockupImage, { duration: 0, x: -Ad.width }, 0);
            ...
            if(myFT.instantAds.F2_lockup_img.indexOf("blank") > -1 && myFT.instantAds.elementsOrder === 'lockup|lockup') {
              document.body.appendChild(frame1LockupImage);
            } else {
              frames[0].appendChild(frame1LockupImage);
            }

            //compute width / height of image

            console.log(frame1LockupImage.width, frame1LockupImage.height)
           
            //gsap.to(frame1LockupImage, { duration: 0, x: -Ad.width }, 0);
            // Ad.timeline.from('div#lockup1', { duration: 1.25, x: -Ad.width }, 0);
        
           // copy.style.marginTop = Number(frame1LockupImage.height) + Number(myFT.instantAds.F1_lockupImg_xy.split(',')[1]) + 'px';
          //  copy.style.marginLeft = Number(myFT.instantAds.F1_lockupImg_xy.split(',')[0]) + 'px';;
         // show ad
      
          //gsap.to(frame1LockupImage, { duration: 0.75, x: Number(myFT.instantAds.F1_lockupImg_xy.split(',')[0]) }, 0);
          ...
          console.log('setup f2');
           ...
           frame2Image.addEventListener("load", function() {
             ...
             if(myFT.instantAds.F2_lockup_img.indexOf("blank") > -1) {
               ...
               var frame2LockupImage = document.createElement('img');
               frame2LockupImage.src = myFT.instantAds.F2_lockup_img;
               frame2LockupImage.addEventListener("load", function() {
               //  frame2LockupImage.style.width = '100%';
              // frame2LockupImage.style.height = '100px';
               frame2LockupImage.style.position = 'absolute';
               frame2LockupImage.style.top = 0;
               frame2LockupImage.id = 'lockup2';
               frame2LockupImage.style.pointerEvents = 'none';
               //frame2LockupImage.style.backgroundSize = 'contain';
               frame2LockupImage.style.marginLeft = myFT.instantAds.F2_lockupImg_xy.split(',')[0] + 'px';
               frame2LockupImage.style.marginTop = myFT.instantAds.F2_lockupImg_xy.split(',')[1] + 'px';
             //  gsap.to(frame2LockupImage, { duration: 0, x: -Ad.width }, 0);
               frames[1].appendChild(frame2LockupImage);
 
              // gsap.to(frame2LockupImage, { duration: 1.25, x: Number(myFT.instantAds.F2_lockupImg_xy.split(',')[0]) }, 0);
             // gsap.to(frame2LockupImage, { duration: 0, x: -Ad.width }, 0);
               Ad.animate();
               });
    ...
    if(Ad.mobileLayout) {
      cta.style.center = (Ad.footer.offsetWidth - cta.offsetWidth)/2 + 'px';
    ...
    if(flag === 'percent') {
      ...
      if(myFT.instantAds.percentage_txt.includes('|')) { 
        ...
        if(Ad.msieversion()) {
          ...
          signNode.style.paddingTop = '0.28em';
  ...
  */
  styleHeadline: function (element, styles) {
    ...
    if(element.id === 'headline') {
      element.style.marginLeft = split[2].split(",")[0] + 'px';
    } else {
      element.style.marginLeft =  Number(myFT.instantAds.headline_size_hex_xy.split("|")[2].split(",")[0]) + Number(split[2].split(",")[0]) + 'px';
    }
