...
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(g,v,p){g!=Array.prototype&&g!=Object.prototype&&(g[v]=p.value)};$jscomp.getGlobal=function(g){return"undefined"!=typeof window&&window===g?g:"undefined"!=typeof global&&null!=global?global:g};$jscomp.global=$jscomp.getGlobal(this);$jscomp.SYMBOL_PREFIX="jscomp_symbol_";
...
$jscomp.iteratorPrototype=function(g){$jscomp.initSymbolIterator();g={next:g};g[$jscomp.global.Symbol.iterator]=function(){return this};return g};$jscomp.iteratorFromArray=function(g,v){$jscomp.initSymbolIterator();g instanceof String&&(g+="");var p=0,w={next:function(){if(p<g.length){var A=p++;return{value:v(A,g[A]),done:!1}}w.next=function(){return{done:!0,value:void 0}};return w.next()}};w[Symbol.iterator]=function(){return w};return w};
$jscomp.polyfill=function(g,v,p,w){if(v){p=$jscomp.global;g=g.split(".");for(w=0;w<g.length-1;w++){var A=g[w];A in p||(p[A]={});p=p[A]}g=g[g.length-1];w=p[g];v=v(w);v!=w&&null!=v&&$jscomp.defineProperty(p,g,{configurable:!0,writable:!0,value:v})}};$jscomp.polyfill("Array.prototype.keys",function(g){return g?g:function(){return $jscomp.iteratorFromArray(this,function(g){return g})}},"es6","es3");
function dv_baseHandler(){function g(a){var b=window._dv_win,e=0;try{for(;10>e;){if(b[a]&&"object"===typeof b[a])return!0;if(b==b.parent)break;e++;b=b.parent}}catch(d){}return!1}function v(a){var b=0,e;for(e in a)a.hasOwnProperty(e)&&++b;return b}function p(a,b){a:{var e={};try{if(a&&a.performance&&a.performance.getEntries){var d=a.performance.getEntries();for(a=0;a<d.length;a++){var c=d[a],n=c.name.match(/.*\/(.+?)\./);if(n&&n[1]){var f=n[1].replace(/\d+$/,""),k=b[f];if(k){for(var g=0;g<k.stats.length;g++){var r=
k.stats[g];e[k.prefix+r.prefix]=Math.round(c[r.name])}delete b[f];if(!v(b))break}}}}var l=e;break a}catch(D){}l=void 0}if(l&&v(l))return l}function w(a,b){function e(a){var c=r,b;for(b in a)a.hasOwnProperty(b)&&(c+=["&"+b,"="+a[b]].join(""));return c}function d(){return Date.now?Date.now():(new Date).getTime()}function c(c){if(!J){J=!0;var b={};b[t.MONITORING_INIT]=1;b[t.DVM_INJECT_FLOW]=c;c=e(b);$dvbs.domUtilities.addImage(c,document.body);try{c="https://cdn.doubleverify.com/dvtp_src.js#tagtype=video";
b="ctx cmp plc sid adsrv adid crt advid prr dup turl iframe ad vssd apifw vstvr tvcp ppid auip pltfrm gdpr gdpr_consent adu invs litm ord sadv scrt vidreg seltag splc spos sup unit dvtagver msrapi vfwctx auprice audeal auevent auadv aucmp aucrtv auorder ausite auplc auxch audvc aulitem auadid autt c1 c2 c3 c4 c5 c6 c7 c8 c9 c10 c11 c12 c13 c14 c15 aufilter1 aufilter2 ppid".split(" ");for(var f=0;f<b.length;f++){var n=b[f],l=k(a,n);void 0!==l&&(c+=["&",n,"=",encodeURIComponent(l)].join(""))}c+="&gmnpo="+
("1"==a.gmnpo?"1":"0");c+="&dvp_dvtpts="+d();c+="&bsimpid="+g;void 0!==a.dvp_aubndl&&(c+="&aubndl="+encodeURIComponent(a.dvp_aubndl));for(var m in a)a.hasOwnProperty(m)&&m.match(/^(dvp|dvpx|tde)_/i)&&a[m]&&(c+=["&",m.toLocaleLowerCase(),"=",encodeURIComponent(a[m])].join(""));$dvbs.domUtilities.addScriptResource(c,document.body)}catch(P){n=e({cerrt:E.INJECT_SCRIPT_ERROR,cemsg:P}),$dvbs.domUtilities.addImage(n,document.body)}}}function n(a){var c={};c[a]=d();a=e(c);$dvbs.domUtilities.addImage(a,document.body)}
function f(a,c){-1<x.indexOf(a)?n(c):h.subscribe(function(){n(c)},a)}function k(a,c){c=c.toLowerCase();for(var b in a)if(b.toLowerCase()===c)return a[b];return null}var g=a.impressionId,r=window._dv_win.dv_config.bsEventJSURL?window._dv_win.dv_config.bsEventJSURL:"https://"+a.ServerPublicDns+"/bsevent.gif";r+="?flvr=0&impid="+encodeURIComponent(g);var l={};l[t.VPAID_FLOW_INIT]=1;var D=e(l),u="responseReceived_"+g,m=a.DVP_DCB||a.DVP_DECISION_CALLBACK,q=k(a,"adid"),v=function(a){var c=a;switch(a){case 5:c=
1;break;case 6:c=2}return c}(b.ResultID),J=!1;$dvbs.domUtilities.addImage(D,document.body);if("function"===typeof window[m]){var w=!1;setTimeout(function(){var a={};a[t.WAS_CALLBACK_CALLED]=w;a=e(a);$dvbs.domUtilities.addImage(a,document.body)},1E3);window[u]=function(a,b,f,n,l,k,m){w=!0;try{if(m){var h={};h[t.CB_STATE]=m;var g=e(h);$dvbs.domUtilities.addImage(g,document.body)}else{h={};h[t.PARTNER_CB_CALLED]=d();g=e(h);$dvbs.domUtilities.addImage(g,document.body);h={};h[t.C_START_TIMESTAMP]=f;h[t.C_END_TIMESTAMP]=
n;h[t.D_RECEIVED_TIMESTAMP]=l;h[t.WAS_AD_PLAYED]=a;f=h;n="";for(var q in f)f.hasOwnProperty(q)&&(n+=["&"+q,"="+f[q]].join(""));var r=n;q=v;if(!b)switch(q=2,v){case 1:var u=21;break;case 2:u=20;break;case 3:u=22;break;case 4:u=23}q={bres:q};q[t.BLOCKING_DECISION_USED]=b?"1":"0";u&&(q.breason=u);g=e(q)+r;$dvbs.domUtilities.addImage(g,document.body,k);a&&!K()&&c("adplayed")}}catch(Q){a=e({cerrt:E.INNOVID_CALLBACK_INIT_EXCEPTION,cemsg:Q}),$dvbs.domUtilities.addImage(a,document.body)}};try{l={};l[t.VPAID_CB_CALLED]=
d();var p=e(l);$dvbs.domUtilities.addImage(p,document.body);window[m](v,u)}catch(F){b=e({cerrt:E.INNOVID_CALLBACK_EX_ERR,cemsg:F}),$dvbs.domUtilities.addImage(b,document.body)}}else b=e({cerrt:E.INNOVID_CALLBACK_MISSING}),$dvbs.domUtilities.addImage(b,document.body);try{var h=window[q]();if(h.getPreviousEvents&&"function"===typeof h.getPreviousEvents){l={};l[t.SUBSCRIBED_TO_ADSTART]=d();p=e(l);$dvbs.domUtilities.addImage(p,document.body);var x=h.getPreviousEvents(),B=0;-1<x.indexOf("AdStarted")?(B=
1,c("ad_started_triggered")):h.subscribe(function(){return c("ad_started_subscribe")},"AdStarted");l={};l[t.AD_STARTED]=B;l[t.PREVIOUS_EVENTS]=x;p=e(l);$dvbs.domUtilities.addImage(p,document.body);f("AdError",t.AD_ERROR);f("AdStopped",t.AD_STOPPED);f("AdVideoStart",t.AD_VIDEO_START);f("AdImpression",t.AD_IMPRESSION)}else B=e({cerrt:E.INNOVID_CALLBACK_NOT_A_FUNCTION,cemsg:"vpaidWrapper.getPreviousEvents not a function"}),$dvbs.domUtilities.addImage(B,document.body)}catch(F){l={cerrt:E.INNOVID_CALLBACK_EXCEPTION,
cemsg:F},l[t.AD_ID]=q,l[t.AD_ID_TYPE]=typeof window[q],B=e(l),$dvbs.domUtilities.addImage(B,document.body)}}function A(a,b){try{$dvbs.registerEventCall(a,{dvp_te_exec:R.RTN}),Object.keys(b).length&&b.forEach(function(b){b.actions&&b.actions.length?b.actions.forEach(function(d){$dvbs.pubSub.subscribe(b.eventName,a,"RTN_"+b.eventName,function(){d.url&&d.actionType&&("image"===d.actionType?navigator.sendBeacon(d.url):"javascript"===d.actionType&&$dvbs.domUtilities.addScriptResource(d.url,document.body))})}):
...
d.ServerContext.rtn&&d.ServerContext.rtn.events&&A(b,d.ServerContext.rtn.events)}}function T(a){var b=null,e=null,d=function(a){var c=dv_GetParam(a,"cmp");a=dv_GetParam(a,"ctx");return"919838"==a&&"7951767"==c||"919839"==a&&"7939985"==c||"971108"==a&&"7900229"==c||"971108"==a&&"7951940"==c?"</scr'+'ipt>":/<\/scr\+ipt>/g}(a.src);"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")});var c=function(a){!(a=a.previousSibling)||"#text"!=a.nodeName||
...
e=a.innerHTML.replace(d,"\x3c/script>");a=c(a);a.hasPassback=!0;return a}return{isBadImp:!0,hasPassback:!1,tagAdTag:b,tagPassback:e}};return c(a)}function K(){try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv)return 1}catch(a){}return 0}function L(a,b,e,d,c,n,f,k,v,r,l,D){b.dvregion=0;var u=dv_GetParam(h,"useragent");h=window._dv_win.$dvbs.CommonData;if(void 0!=h.BrowserId&&void 0!=h.BrowserVersion&&void 0!=h.BrowserIdFromUserAgent)var m={ID:h.BrowserId,version:h.BrowserVersion,
ID_UA:h.BrowserIdFromUserAgent};else m=U(u?decodeURIComponent(u):navigator.userAgent),h.BrowserId=m.ID,h.BrowserVersion=m.version,h.BrowserIdFromUserAgent=m.ID_UA;var q="";void 0!=b.aUrl&&(q="&aUrl="+b.aUrl);var t="";try{d.depth=V(d);var p=W(d,e,m);if(p&&p.duration){var w="&dvp_strhd="+p.duration;w+="&dvpx_strhd="+p.duration}p&&p.url||(p=X(d));p&&p.url&&(q="&aUrl="+encodeURIComponent(p.url),t="&aUrlD="+p.depth);var C=d.depth+c;n&&d.depth--}catch(B){w=t=q=C=d.depth=""}c=K();n=function(){function a(c){b++;
var d=c.parent==c;return c.mraid||d?c.mraid:20>=b&&a(c.parent)}var c=window._dv_win||window,b=0;try{return a(c)}catch(ia){}}();var h=b.script.src;c="&ctx="+(dv_GetParam(h,"ctx")||"")+"&cmp="+(dv_GetParam(h,"cmp")||"")+"&plc="+(dv_GetParam(h,"plc")||"")+"&sid="+(dv_GetParam(h,"sid")||"")+"&advid="+(dv_GetParam(h,"advid")||"")+"&adsrv="+(dv_GetParam(h,"adsrv")||"")+"&unit="+(dv_GetParam(h,"unit")||"")+"&isdvvid="+(dv_GetParam(h,"isdvvid")||"")+"&uid="+b.uid+"&tagtype="+(dv_GetParam(h,"tagtype")||"")+
"&adID="+(dv_GetParam(h,"adID")||"")+"&app="+(dv_GetParam(h,"app")||"")+"&sup="+(dv_GetParam(h,"sup")||"")+"&isovv="+c+"&gmnpo="+(dv_GetParam(h,"gmnpo")||"")+"&crt="+(dv_GetParam(h,"crt")||"");c+="&dvp_rdyst="+document.readyState+"&dvp_intrst=1&dvp_ttp="+(dv_GetParam(h,"dvp_ttp")||"");"1"==dv_GetParam(h,"foie")&&(c+="&foie=1");n&&(c+="&ismraid=1");(n=dv_GetParam(h,"xff"))&&(c+="&xff="+n);(n=dv_GetParam(h,"vssd"))&&(c+="&vssd="+n);(n=dv_GetParam(h,"apifw"))&&(c+="&apifw="+n);(n=dv_GetParam(h,"vstvr"))&&
(c+="&vstvr="+n);(n=dv_GetParam(h,"tvcp"))&&(c+="&tvcp="+n);l&&(c+="&urlsrc=sf");D&&(c+="&sfe=1");navigator&&navigator.maxTouchPoints&&5==navigator.maxTouchPoints&&(c+="&touch=1");navigator&&navigator.platform&&(c+="&nav_pltfrm="+navigator.platform);w&&(c+=w);u&&(c+="&useragent="+u);m&&(c+="&brid="+m.ID+"&brver="+m.version+"&bridua="+m.ID_UA);c+="&dup="+dv_GetParam(h,"dup");try{c+=dv_AppendIQPAParams(h)}catch(B){}(l=dv_GetParam(h,"turl"))&&(c+="&turl="+l);(l=dv_GetParam(h,"tagformat"))&&(c+="&tagformat="+
l);"video"===dv_GetParam(h,"tagtype")&&(c+="&DVP_BYPASS219=1");c+=Y();r=r?"&dvf=0":"";l=g("maple")?"&dvf=1":"";f=(window._dv_win.dv_config.verifyJSURL||"https://"+(window._dv_win.dv_config.bsAddress||"rtb"+b.dvregion+".doubleverify.com")+"/verify.js")+"?flvr=0&jsCallback="+b.callbackName+"&jsTagObjCallback="+b.tagObjectCallbackName+"&num=6"+c+"&srcurlD="+d.depth+"&ssl="+b.ssl+r+l+"&refD="+C+b.tagIntegrityFlag+b.tagHasPassbackFlag+"&htmlmsging="+(f?"1":"0")+"&tstype="+M(window._dv_win);(C=dv_GetDynamicParams(h,
"dvp").join("&"))&&(f+="&"+C);(C=dv_GetDynamicParams(h,"dvpx").join("&"))&&(f+="&"+C);if(!1===k||v)f=f+("&dvp_isBodyExistOnLoad="+(k?"1":"0"))+("&dvp_isOnHead="+(v?"1":"0"));e="srcurl="+encodeURIComponent(e);(k=Z())&&(e+="&ancChain="+encodeURIComponent(k));(d=aa(d))&&(e+="&canurl"+encodeURIComponent(d));d=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(d=2E3);if(k=dv_GetParam(h,"referrer"))k="&referrer="+k,f.length+k.length<=d&&(f+=k);(k=dv_GetParam(h,"prr"))&&(f+="&prr="+
k);(k=dv_GetParam(h,"iframe"))&&(f+="&iframe="+k);(k=dv_GetParam(h,"gdpr"))&&(f+="&gdpr="+k);(k=dv_GetParam(h,"gdpr_consent"))&&(f+="&gdpr_consent="+k);q.length+t.length+f.length<=d&&(f+=t,e+=q);(q=ba())&&(f+="&m1="+q);(q=ca())&&0<q.f&&(f+="&bsig="+q.f,f+="&usig="+q.s);q=da();0<q&&(f+="&hdsig="+q);navigator&&navigator.hardwareConcurrency&&(f+="&noc="+navigator.hardwareConcurrency);f+=ea();q=fa();f+="&vavbkt="+q.vdcd;f+="&lvvn="+q.vdcv;""!=q.err&&(f+="&dvp_idcerr="+encodeURIComponent(q.err));"prerender"===
window._dv_win.document.visibilityState&&(f+="&prndr=1");(h=dv_GetParam(h,"wrapperurl"))&&1E3>=h.length&&f.length+h.length<=d&&(f+="&wrapperurl="+h);f+="&"+a.getVersionParamName()+"="+a.getVersion();a="&eparams="+encodeURIComponent(G(e));f=f.length+a.length<=d?f+a:f+"&dvf=3";window.performance&&window.performance.mark&&window.performance.measure&&window.performance.getEntriesByName&&(window.performance.mark("dv_create_req_end"),window.performance.measure("dv_creqte_req","dv_create_req_start","dv_create_req_end"),
...
arguments)},g=["Moz","O","ms","Webkit"],f=["moz","o","ms","webkit"],k={style:c("modernizr").style},p=function(a,b){function d(a){return a.replace(/([a-z])-([a-z])/g,function(a,b,c){return b+c.toUpperCase()}).replace(/^-/,"")}function e(){l&&(delete k.style,delete k.modElem)}var f;for(f=["modernizr","tspan","samp"];!k.style&&f.length;){var l=!0;k.modElem=c(f.shift());k.style=k.modElem.style}var g=a.length;for(f=0;f<g;f++){var n=a[f];~(""+n).indexOf("-")&&(n=d(n));if(void 0!==k.style[n])return e(),
"pfx"==b?n:!0}e();return!1},r=function(a,b,c){var d=a.charAt(0).toUpperCase()+a.slice(1),l=(a+" "+g.join(d+" ")+d).split(" ");if("string"===typeof b||"undefined"===typeof b)return p(l,b);l=(a+" "+f.join(d+" ")+d).split(" ");for(var k in l)if(l[k]in b){if(!1===c)return l[k];a=b[l[k]];return"function"===typeof a?e(a,c||b):a}return!1};b(0,!0);b(1,r("requestFileSystem",window));b(2,window.CSS?"function"==typeof window.CSS.escape:!1);b(3,r("shapeOutside","content-box",!0));return a}catch(l){return 0}}
...
(a+="&flt="+(b.performance.timing.domainLookupEnd-b.performance.timing.domainLookupStart));e.querySelectorAll&&(a+="&fec="+e.querySelectorAll("*").length)}return a}catch(d){return""}}var z=this,t={VPAID_FLOW_INIT:"ee_dp_vfinit",VPAID_CB_CALLED:"ee_dp_vcbc",PARTNER_CB_CALLED:"ee_dp_pcbc",SUBSCRIBED_TO_ADSTART:"ee_dp_subadstrt",MONITORING_INIT:"ee_dp_moninit",AD_STARTED:"ee_dp_adstrt",CB_STATE:"ee_dp_cbst",WAS_CALLBACK_CALLED:"ee_dp_wcb",C_START_TIMESTAMP:"ee_dp_cst",C_END_TIMESTAMP:"ee_dp_cet",D_RECEIVED_TIMESTAMP:"ee_dp_drt",
WAS_AD_PLAYED:"ee_dp_wap",AD_ID:"ee_dp_adid",AD_ID_TYPE:"ee_dp_adidt",AD_ERROR:"ee_dp_ader",AD_STOPPED:"ee_dp_adstp",AD_VIDEO_START:"ee_dp_avse",AD_IMPRESSION:"ee_dp_aie",BLOCKING_DECISION_USED:"ee_dp_bdu",PREVIOUS_EVENTS:"ee_dp_prvevnts",DVM_INJECT_FLOW:"ee_dp_dvm_inj"},E={INNOVID_CALLBACK_INIT_EXCEPTION:1,INNOVID_CALLBACK_EXCEPTION:2,INNOVID_CALLBACK_NOT_A_FUNCTION:4,INNOVID_CALLBACK_EX_ERR:8,INNOVID_CALLBACK_MISSING:16,INJECT_SCRIPT_ERROR:32},y=function(){function a(a,b){var e=[];b&&g.forEach(function(a){var c=
dv_GetParam(b,a);""!==c&&null!==c&&e.push(["dvp_"+a,c].join("="))});var f=window&&window._dv_win||{};f=f.dv_config=f.dv_config||{};f=dv_getDVBSErrAddress(f);var l=[c,d].join("="),n=["dvp_cert",k[a]].join("=");a=["dvp_jsErrMsg",a].join("=");f+=["/verify.js?flvr=0&ctx=818052&cmp=1619415&dvp_isLostImp=1&ssl=1",l,n,a,e.join("&")].join("&");(new Image(1,1)).src="https://"+f}function b(b,c){var d=window._dv_win.dv_config.bs_renderingMethod||function(a){document.write(a)};c="AdRenderedUponVerifyFailure__"+
(c||"");if(z&&z.tagParamsObj&&z.tagParamsObj.tagAdtag)try{d(z.tagParamsObj.tagAdtag)}catch(u){c+="__RenderingMethodFailed"}else z?z.tagParamsObj?z.tagParamsObj.tagAdtag||(c+="__HandlerTagParamsObjTagAdtag__Undefined"):c+="__HandlerTagParamsObj__Undefined":c+="__Handler__Undefined";a(c,b)}var e=!1,d,c,g=["ctx","cmp","plc","sid"],f=[z.constructor&&z.constructor.name||"UKDV","__",H()].join(""),k={VerifyLoadJSONPCallbackFailed:1,VerifyFailedToLoad:2},p={onResponse:function(c){e||(a("VerifyCallbackFailed",
c),b(c,"VCF"))},onError:function(c){a("VerifyFailedToLoad",c);b(c,"VFTL")}};p.reportError=a;p.isJSONPCalled=e;window._dv_win[f]={globalScopeVerifyErrorHandler:p};return{setVersionData:function(a,b){c=a;d=b},setIsJSONPCalled:function(a){e=a},getIsJSONPCalled:function(){return e},onLoad:dv_onResponse,onError:dv_onError,uniqueKey:f}}();this.createRequest=function(){window.performance&&window.performance.mark&&window.performance.mark("dv_create_req_start");var a=!1,b=window._dv_win,e=0,d=!1,c;try{for(c=
0;10>=c;c++)if(null!=b.parent&&b.parent!=b)if(0<b.parent.location.toString().length)b=b.parent,e++,a=!0;else{a=!1;break}else{0==c&&(a=!0);break}}catch(q){a=!1}a:{try{var g=b.$sf;break a}catch(q){}g=void 0}var f=(c=b.location&&b.location.ancestorOrigins)&&c[c.length-1];if(0==b.document.referrer.length)a=b.location;else if(a)a=b.location;else{a=b.document.referrer;a:{try{var k=b.$sf&&b.$sf.ext&&b.$sf.ext.hostURL&&b.$sf.ext.hostURL();break a}catch(q){}k=void 0}if(k&&(!c||0==k.indexOf(f))){a=k;var p=
!0}d=!0}if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};c=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();k=c.script;this.dv_script_obj=c;this.dv_script=k;window._dv_win.dvbsProcessed.push(c);window._dv_win._dvScripts.push(k);f=k.src;this.dvOther=0;this.dvStep=1;var r=window._dv_win.dv_config?
window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():H():H();c=window.parent.postMessage&&window.JSON;var l={};try{for(var t=/[\?&]([^&]*)=([^&#]*)/gi,u=t.exec(f);null!=u;)"eparams"!==u[1]&&(l[u[1]]=u[2]),u=t.exec(f);var m=l}catch(q){m=l}this.tagParamsObj=m;m.perf=this.perf;m.uid=r;m.script=this.dv_script;m.callbackName="__verify_callback_"+m.uid;m.tagObjectCallbackName="__tagObject_callback_"+m.uid;m.tagAdtag=null;m.tagPassback=null;m.tagIntegrityFlag="";m.tagHasPassbackFlag="";
0==(null!=m.tagformat&&"2"==m.tagformat)&&(u=T(m.script),m.tagAdtag=u.tagAdTag,m.tagPassback=u.tagPassback,u.isBadImp?m.tagIntegrityFlag="&isbadimp=1":u.hasPassback&&(m.tagHasPassbackFlag="&tagpb=1"));u=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream;m.protocol="https:";m.ssl="1";f=m;(r=window._dv_win.dvRecoveryObj)?("2"!=f.tagformat&&(r=r[f.ctx]?r[f.ctx].RecoveryTagID:
r._fallback_?r._fallback_.RecoveryTagID:1,1===r&&f.tagAdtag?document.write(f.tagAdtag):2===r&&f.tagPassback&&document.write(f.tagPassback)),f=!0):f=!1;if(f)return{isSev1:!0};this.dvStep=2;S(m);k=k&&k.parentElement&&k.parentElement.tagName&&"HEAD"===k.parentElement.tagName;this.dvStep=3;return L(this,m,a,b,e,d,c,!0,k,u,p,g)};this.sendRequest=function(a){var b=dv_GetParam(a,"tagformat");if(y)try{y.setVersionData(this.getVersionParamName(),this.getVersion()),b&&"2"==b?$dvbs.domUtilities.addScriptResource(a,
document.body,y.onLoad,y.onError,y.uniqueKey):dv_sendScriptRequest(a,y.onLoad,y.onError,y.uniqueKey)}catch(e){b&&"2"==b?$dvbs.domUtilities.addScriptResource(a,document.body):dv_sendScriptRequest(a)}else b&&"2"==b?$dvbs.domUtilities.addScriptResource(a,document.body):dv_sendScriptRequest(a);return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};var R={RTN:1};window.debugScript&&(window.CreateUrl=L);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"178"}}
;
