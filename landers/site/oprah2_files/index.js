function init(){
	...
	function initAnimation() {
		...
		if(creative.includes('hsd') === true){
			...
			gsap.set(athlete, {alpha:0, scale:.84, transformOrigin:"0% 100%"});
			gsap.set(bg, {transformOrigin:"50% 50%"});

			if(creative === 'hsd alt'){

				gsap.set(athlete, {alpha:0, scale:1, transformOrigin:"0% 100%"});
				...
				timeline.add([
					...
					gsap.to(athlete, 4.1, {x:8, y:0, scale:1, ease:Linear.easeNone}),
					...
					gsap.to(logo, .5, {y:"-=0", ease:Cubic.easeInOut, delay:4.7}),
				...
				timeline.add([
					...
					gsap.to(athlete, .5, {alpha:1, ease:Cubic.easeInOut}),
					gsap.to(athlete, 5.5, {x:5, y:0, scale:1, ease:Linear.easeNone}),
					gsap.to(bg, 5, {scale:1.4, ease:Linear.easeNone}),
					gsap.to(athleteSignature, .5, {alpha:1, ease:Cubic.easeInOut, delay:.1}),
					gsap.to(athleteInfo, .5, {alpha:1, ease:Cubic.easeInOut, delay:.2}),
					...
					// frame 4
					gsap.to([f3_copy, athlete], .5, {alpha:0, ease:Cubic.easeInOut, delay:5.9}),
					gsap.to([f4_copy], .5, {alpha:1, ease:Cubic.easeInOut, delay:6.2, onStart:function(){
						if(creative === 'hsd offer'){
							gsap.to(offer, .5, {alpha:1, ease:Cubic.easeInOut, delay:.1});
						}
					}}),
			...
			gsap.set(athlete, {alpha:0, scale:.92, transformOrigin:"0% 100%"});
			...
			timeline.add([
				...
				gsap.to(athlete, 5.2, {x:0, y:0, scale:1, ease:Linear.easeNone}),
				gsap.to(bg, 5, {scale:1.4, ease:Linear.easeNone}),
				gsap.to(athleteProps, 5.2, {x:152, y:-33, scale:1, rotation:25, ease:Linear.easeNone}),
				gsap.to(athleteSignature, .5, {alpha:1, ease:Cubic.easeInOut, delay:.1}),
				gsap.to(athleteInfo, .5, {alpha:1, ease:Cubic.easeInOut, delay:.2}),
				...
				gsap.to(logo, .6, {x:0, y:logoPos, ease:Cubic.easeInOut, delay:5.1}),
			...
			timeline.add([
				...
				gsap.to(device, .5, {x:-61, y:0, scale:1, ease:Cubic.easeInOut, delay:7.7}),
